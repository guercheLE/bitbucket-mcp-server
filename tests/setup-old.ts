...
// Global test utilities for MCP testing - use simple function declarations
function mockMCPMessage(type: string, data: any = {}) {
  return {
    jsonrpc: '2.0',
...
async function waitForAsync(fn: () => Promise<any>, timeout: number = 5000): Promise<any> {
