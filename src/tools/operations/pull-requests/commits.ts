...
export const listPullRequestCommitsOperation: OperationContract = {
  id: 'bitbucket.pull-requests.commits',
  method: 'GET',
  path: '/2.0/repositories/{workspace}/{repo_slug}/pullrequests/{pull_request_id}/commits',
  description: 'List commits associated with a pull request.',
