...
const bitbucketPageParameter = z.string({
  description: 'Opaque cursor identifying the results page.',
});
...
const _mcpPaginationSchema = z.object({
  cursor: bitbucketPageParameter.optional(),
  limit: bitbucketPageLenParameter.optional(),
});

export type McpPaginationParams = z.infer<typeof _mcpPaginationSchema>;
...
export const normalizePaginationParams = (params?: PaginationInput): BitbucketPaginationParams => {
  if (!params) {
    return {};
  }
