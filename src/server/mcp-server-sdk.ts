...
export class MCPServerSDK extends Server {
  ...
  private registeredPrompts: Map<string, Prompt> = new Map();
   ...
   */
  async registerPrompt(prompt: Prompt): Promise<void> {
 ...
 */
export async function createMCPServerWithSDK(
  config: ServerConfig, 
  customServer: MCPServer
): Promise<MCPServerSDK> {
