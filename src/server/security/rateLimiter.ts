...
const defaultKeyGenerator = (req: Request, extractUserId: (req: Request) => string | null): string => {
...
export const createRateLimiter = (options: CombinedRateLimiterOptions = {}): RateLimitRequestHandler => {
    const {
