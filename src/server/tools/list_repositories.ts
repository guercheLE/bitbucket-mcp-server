 ...
 */
const listRepositoriesParameters: ToolParameter[] = [
  {
    name: 'workspace',
    type: 'string',
 ...
 */
const listRepositoriesExecutor: ToolExecutor = async (params: Record<string, any>, context: ToolExecutionContext): Promise<ToolResult> => {
  try {
    // Set default values
