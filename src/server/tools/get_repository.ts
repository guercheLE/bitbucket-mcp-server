 ...
 */
const getRepositoryParameters: ToolParameter[] = [
  {
    name: 'workspace',
    type: 'string',
 ...
 */
const getRepositoryExecutor: ToolExecutor = async (params: Record<string, any>, context: ToolExecutionContext): Promise<ToolResult> => {
  try {
