 ...
 */
const repositoryLifecycleParameters: ToolParameter[] = [
  {
    name: 'workspace',
    type: 'string',
 ...
 */
const repositoryLifecycleExecutor: ToolExecutor = async (params: Record<string, any>, context: ToolExecutionContext): Promise<ToolResult> => {
  try {
      ...
      case 'cleanup':
        ...
        if (params.dry_run) {
          result = {
            ...
            would_cleanup: cleanupResults[params.cleanup_type as keyof typeof cleanupResults] || cleanupResults,
          ...
          result = {
            ...
            workspace: params.workspace,
            cleanup_type: params.cleanup_type,
            cleanup_results: cleanupResults[params.cleanup_type as keyof typeof cleanupResults] || cleanupResults,
 ...
 */
export const repositoryLifecycleTool: Tool = {
