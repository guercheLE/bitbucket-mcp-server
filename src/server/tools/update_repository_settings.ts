 ...
 */
const updateRepositorySettingsParameters: ToolParameter[] = [
  {
    name: 'workspace',
    type: 'string',
 ...
 */
const updateRepositorySettingsExecutor: ToolExecutor = async (params: Record<string, any>, context: ToolExecutionContext): Promise<ToolResult> => {
  try {
 ...
 */
export const updateRepositorySettingsTool: Tool = {
