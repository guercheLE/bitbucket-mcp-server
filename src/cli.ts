...
export const buildCli = (dependencies: CliDependencies = {}): Command => {
    ...
    program
        ...
        .action(async (opts: { port?: number; logLevel?: LogLevelOption; host?: string; username?: string; password?: string }) => {
    ...
    program
        ...
        .option("--port <port>", "HTTP port the MCP server is listening on", (value) => Number(value), 3000)
