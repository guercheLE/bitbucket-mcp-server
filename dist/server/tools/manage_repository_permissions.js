 ...
 */
const manageRepositoryPermissionsParameters = [
    {
        name: 'workspace',
        type: 'string',
 ...
 */
const manageRepositoryPermissionsExecutor = async (params, context) => {
    try {
 ...
 */
export const manageRepositoryPermissionsTool = {
...
//# sourceMappingURL=manage_repository_permissions.js.map