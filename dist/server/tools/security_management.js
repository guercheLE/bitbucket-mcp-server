 ...
 */
const securityManagementParameters = [
    {
        name: 'action',
        type: 'string',
 ...
 */
const securityManagementExecutor = async (params, context) => {
 ...
 * Handle MFA setup
 */
async function handleMfaSetup(mfaManager, auditLogger, context, startTime) {
    try {
 ...
 */
async function handleMfaVerification(mfaManager, auditLogger, params, context, startTime) {
    try {
 ...
 */
async function handleMfaDisable(auditLogger, params, context, startTime) {
...
async function handleBackupCodeRegeneration(mfaManager, auditLogger, context, startTime) {
...
async function handleSecurityStatus(auditLogger, params, context, startTime) {
...
async function handleAuditLogs(auditLogger, params, context, startTime) {
...
async function handleSecurityStats(auditLogger, params, context, startTime) {
    // Admin only
...
async function handleSessionInfo(auditLogger, context, startTime) {
    return {
        success: true,
        data: {
            sessionId: context.session?.id,
...
async function handleTerminateSessions(auditLogger, params, context, startTime) {
...
async function handlePermissionCheck(auditLogger, params, context, startTime) {
...
//# sourceMappingURL=security_management.js.map