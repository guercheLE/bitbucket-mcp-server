...
export class AuthenticationManager extends EventEmitter {
    ...
    async handleCallback(request) {
        try {
            ...
            // Create user session
            const sessionResponse = await this.sessionManager.createSession(this.generateClientSessionId(), appResponse.data, tokenResponse.data.accessToken, tokenResponse.data.refreshToken, userInfo);
     ...
     */
    async authenticateRequest(authHeader, sessionId) {
        try {
