...
import { UserSessionState, AuthenticationErrorCode } from '../../types/auth';
/**
...
export class SessionManager extends EventEmitter {
    sessions = new Map();
    clientSessionMap = new Map(); // clientSessionId -> userSessionId
    oauthManager;
    config;
    constructor(oauthManager, config) {
        super();
     ...
     */
    async createSession(clientSessionId, application, accessToken, refreshToken, userInfo) {
        try {
     ...
     */
    async getSessionByClientId(clientSessionId) {
        try {
    ...
    calculateAverageRequestInterval(session) {
