 ...
 */
export declare enum UserSessionState {
 ...
 */
export declare class AuthenticationErrorClass extends Error {
    readonly code: AuthenticationErrorCode;
    readonly details?: any;
    readonly timestamp: Date;
    readonly sessionId?: string;
 ...
 */
export declare function isOAuthApplication(obj: any): obj is OAuthApplication;
/**
 ...
 */
export declare function isUserSession(obj: any): obj is UserSession;
export * from './auth';
