...
export { WorkspaceManager, WorkspaceManagerEvents } from './manager.js';
export { FileWorkspaceStorage } from './storage.js';
// Context provider
export { WorkspaceContextProvider } from './context.js';
...
import { AuthenticationType, DEFAULT_WORKSPACE_CONFIG, isWorkspaceConfig, MAX_WORKSPACES, WORKSPACE_ID_PATTERN, WORKSPACE_SLUG_PATTERN, WorkspaceErrorType, WorkspacePriority, WorkspaceStatus } from './types.js';
/**
...
export const WorkspaceUtils = {
     ...
     */
    isWorkspaceOperational(workspace) {
     ...
     */
    sortWorkspacesByPriority(workspaces) {
        const priorityOrder = {
