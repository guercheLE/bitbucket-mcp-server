...
- [ ] All functionality exposed through standardized MCP tools
- [ ] Official MCP SDK used as single source of truth
- [ ] Total compatibility with MCP clients ensured
- [ ] Library-first approach emphasized in all implementations

### Article II: Multi-Transport Protocol
- [ ] Support for stdio, HTTP, SSE, HTTP streaming transports
- [ ] Independent and testable transport implementations
- [ ] Automatic fallback between transports when necessary
- [ ] CLI interface with text I/O protocol support

### Article III: Selective Tool Registration
- [ ] Tools registered based on server type (datacenter/cloud) and version
- [ ] Automatic server type and version detection
- [ ] Graceful degradation for unavailable features
- [ ] Console client commands registered selectively based on server capabilities

### Article IV: Complete API Coverage
- [ ] All Bitbucket Data Center (7.16+) and Cloud APIs implemented as MCP tools
- [ ] Official Atlassian documentation as single source of truth
- [ ] Commands for all Bitbucket API endpoints
- [ ] Integration testing with real dependencies mandatory
...
- [ ] Complexity deviations justified in Complexity Tracking
